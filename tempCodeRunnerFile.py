...
sidebar = tk.Frame(root, bg="#121212", width=220)
...
center_frame = tk.Frame(main, bg="#1A1A1A", width=800, height=500)
center_frame.place(relx=0.5, rely=0.5, anchor="center")   # 🔥 FIX HERE

# IMAGE
img = Image.open("ai_face.png")   # same folder me hona chahiye
...
right.place(relx=0.85, rely=0.5, anchor="center")   # 🔥 better alignment
